      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-left">
            ...
            <p>Aqui testaremos o Carrosel do Bootstrap</p>
            <p><a class="btn btn-lg btn-primary" href="#">Comece hoje</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/img-curso-php.jpg') }}" class="figure-img img-fluid rounded" alt="Curso Laravel">
        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label=" :  " preserveAspectRatio="xMidYMid slice" focusable="false"><title> </title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"> </text></svg>

        <div class="container">
          <div class="carousel-caption">
            <h1>São vários Exemplos</h1>
            <p>Em cada um deles, teremos algo a aprender</p>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-right">
            ...
            <p>A programação não é um bicho de sete cabeças</p>
            <p><a class="btn btn-lg btn-primary" href="#">Projetos feitos</a></p>
          </div>
        </div>
      </div>
    </div>
